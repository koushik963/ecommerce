...
<?php
//$Item_edited .= "Product ID: $targetID - <strong>$product_name</strong> - $$price - <em>Added $date_added</em> &nbsp; &nbsp; &nbsp; ";

?>

<?php 
// To fill the data to Product_list
...
if ($productCount > 0) {
	while($row = mysql_fetch_array($sql)){
			 ...
			 $product_list .= "Product ID: $targetID - <strong>$product_name1</strong> - $$price1 - <em>Added $date_added1</em> &nbsp; &nbsp; &nbsp; <a href='inventory_edit.php?pid=$targetID'>edit</a> &bull; <a href='inventory_list.php?deleteid=$targetID'>delete</a><br />";
             }
	}
} else {
